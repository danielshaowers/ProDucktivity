...
public class MakeRequestTask<EventObjects> extends ArrayAdapter {
    private static final String TAG = MakeRequestTask.class.getSimpleName();
    private LayoutInflater mInflater;
    private List<Date> monthlyDates;
    private Calendar currentDate;
    private List<EventObjects> allEvents;
    public MakeRequestTask(Context context, List<Date> monthlyDates, Calendar currentDate, List<EventObjects> allEvents) {
