...
import com.example.producktivity.database.DatabaseQuery;
...
public class CalendarActivity extends LinearLayout{
    ...
    public CalendarActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CalendarActivity(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setUpCalendarAdapter(){
        ...
        mAdapter = new MakeRequestTask(context, dayValueInCells, cal, mEvents);
